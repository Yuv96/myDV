...
界面使用黑、粉、白及其透明度。头像位于资料卡外侧，宽高相等并与固定高度的资料卡对齐，保留圆形裁切；昵称与数据同一行，简介位于下方。资料卡只随内容调整宽度，标题最多两行，超出省略，切换视频时高度与头像尺寸保持稳定，长内容受屏幕宽度上限约束，保留底部 48dp 安全间距。半透明底色兼容旧电视，不做实时背景模糊。

每次切入视频后，资料卡从视频开始出画面起显示 3 秒；循环播放、暂停恢复和页面返回不重新计时。菜单键打开右侧互动菜单时临时召回资料卡，菜单关闭立即隐藏；切到其他视频后再切回来，会重新显示一次。旧版“常驻/6 秒”偏好不再控制此行为。时间与通知数显示在左上角。
