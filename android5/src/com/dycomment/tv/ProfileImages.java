...
public final class ProfileImages {
    ...
    public static void bind(Activity a,String url,ImageView view) {
        ...
        PreviewImages images=item instanceof PreviewImages ? (PreviewImages)item : new PreviewImages();
        a.getWindow().getDecorView().setTag(TAG,images); images.bind(view,url);
    }
    ...
    public static void close(Activity a) {
        ...
        try { ((Handler)InteractionController.field(a,"mainHandler")).removeCallbacksAndMessages(null); }
