...
apk=root/'dist/Douyin-TV-0.1.3.apk'
...
assert "versionCode='1008'" in info and "versionName='0.1.3'" in info
...
print('PASS production: API21, version 0.1.3 / 1008, no test activities/videos, signer matches a5.4, v0.1.1 and v0.1.2')
